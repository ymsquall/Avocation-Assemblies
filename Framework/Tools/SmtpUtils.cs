...
namespace Framework.Tools
{
    public class SmtpUtils
    {
        ...
        public SmtpUtils(string server, string toMail, string fromMail, string subject, string emailBody, string username, string password, string port = "25", bool sslEnable = false, bool pwdCheckEnable = false)
        {
            try
            {
