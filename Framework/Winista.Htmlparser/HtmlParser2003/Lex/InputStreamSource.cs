	...
	public class InputStreamSource : Source//, System.Runtime.Serialization.ISerializable
	{
		...
		override public System.String Encoding
		{
			...
			set
			{
                ...
                if (PlatformTools.CompareStr(value, "x-user-defined", true) == 0)
				{
					return;
				}
							...
							if (0 != offset)
							{
								...
								for (int i = 0; i < offset; i++)
									if (new_chars[i] != buffer[i])
									{
										...
										{
                                            UnityEngine.Debug.LogError(strMsg);
        ...
        /*
        public void GetObjectData(System.Runtime.Serialization.SerializationInfo out_Renamed, System.Runtime.Serialization.StreamingContext context)
		{
			int offset;
			char[] buffer;
		...
		*/
		...
		public override void  Reset()
		{
            if (null == mStream)
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
				throw new System.Exception("source is closed");
#else
