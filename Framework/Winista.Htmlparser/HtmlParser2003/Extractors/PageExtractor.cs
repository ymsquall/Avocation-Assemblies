	...
	public class PageExtractor : NodeVisitor
	{
		...
		public override void VisitTag(ITag tag)
		{
			...
			if (tag is TitleTag)
			{
                ...
                Winista.Text.HtmlParser.Util.StringUtil.CollapseString(strBuffer, tag.ToPlainTextString());
		...
		private void ProcessMetaTag(MetaTag obTag)
		{
			...
			if (null != strContent)
			{
                Winista.Text.HtmlParser.Util.StringUtil.CollapseString(strBuffer, strContent);
			}
