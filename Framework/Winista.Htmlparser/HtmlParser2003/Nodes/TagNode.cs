...
namespace Winista.Text.HtmlParser.Nodes
{
	...
	public class TagNode : AbstractNode, ITag
	{
		...
		public TagNode():this(null, - 1, - 1,
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
            ArrayList_WP_8_1.ArrayList.Synchronized(new System.Collections.ArrayList(10))
#else
		...
		virtual public System.Collections.Hashtable Attributes
		{
...
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
					ret[SpecialHashtable.TAGNAME] = attribute.GetName().ToUpper();
#else
...
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
							ret[attribute.GetName().ToUpper()] = value_Renamed;
#else
			...
			set
			{
				...
				TagAttribute attribute;
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
				att = ArrayList_WP_8_1.ArrayList.Synchronized(new System.Collections.ArrayList(10));
#else
		...
		virtual public System.String TagName
		{
			...
			set
			{
                ...
                {
#if NETFX_CORE && UNITY_METRO && !UNITY_EDITOR
					attributes = ArrayList_WP_8_1.ArrayList.Synchronized(new System.Collections.ArrayList(10));
#else
